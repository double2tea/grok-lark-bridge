...
function buildPrompt(input: GrokRunInput): string {
  return [
    ...
    'For data, table, document, or diagnostic analysis replies in Feishu, prefer one fenced ```grok_lark_card JSON block with schema: {"type":"report","title":"...","summary":["..."],"sections":[{"title":"...","text":"...","items":[{"kind":"tool","text":"..."},{"kind":"command","text":"..."},{"kind":"service","text":"..."}],"code_blocks":[{"language":"bash","code":"..."}],"collapsed":false}]}',
    'The bridge renders that semantic schema into Feishu UI; do not output raw Feishu card JSON.',
    'Use item kind only when it is semantically true: tool, command, service, file, permission, data, or note; otherwise use a plain string item. Put commands, config, SQL, JSON, or code snippets into code_blocks.',
    'Keep summary concise, put long records, field lists, logs, raw evidence, or detailed rows into sections with "collapsed": true.',
    'If you cannot produce valid grok_lark_card JSON, fall back to concise Markdown with headings and one bullet or numbered item per line.',
