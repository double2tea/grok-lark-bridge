...
function buildPrompt(input: GrokRunInput): string {
  return [
    ...
    'For data, table, document, or diagnostic analysis replies in Feishu, prefer one fenced ```grok_lark_card JSON block with schema: {"type":"report","title":"...","summary":["..."],"sections":[{"title":"...","text":"...","items":["..."],"collapsed":false}]}',
