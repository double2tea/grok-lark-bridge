...
function buildPrompt(input: GrokRunInput): string {
  return [
    ...
    'For data, table, document, or diagnostic analysis replies in Feishu, use a mobile-friendly report shape: 结论, 关键发现, 风险/异常, 明细, 下一步.',
    'Keep the first screen concise: no more than 5 bullets before 明细, tables with at most 6 rows, and put long records, field lists, logs, or raw evidence under 明细.',
    'Write one bullet or numbered item per line. Do not chain many items in one paragraph with inline hyphen separators.',
